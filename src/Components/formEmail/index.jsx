  ...
  return (
    <div className="no-gutters">
            ...
            <div className="col-lg-12 contact-box m-0 smb-4">
                ...
                <form className="mt-3" action="https://formsubmit.co/contato@harcoassessoria.com.br" method="POST">
                    <input type="hidden" name="_template" value="table"/>
                    <div className="row">
                    <div className="col-lg-12">
                        <div className="form-group mt-2">
                        <input className="form-control" name='name' type="text" placeholder="Nome" required/>
                        </div>
                    </div>
                    <div className="col-lg-12">
                        <div className="form-group mt-2">
                    ...
                    <div className="col-lg-12">
                        <div className="form-group mt-2">
                        <textarea className="form-control" name='message' rows="7" placeholder="Mensagem" required></textarea>
                        </div>
                    </div>
